...
class log(minqlx.Plugin):
    ...
    def handle_chat(self, player, msg, channel):
        ...
        self.chatlog.info(self.clean_text("{}<{}:{}> {}".format(channel_name, player, player.steam_id, msg)))

    def handle_command(self, caller, command, args):
        self.chatlog.info(self.clean_text("[CMD] <{}:{}> {}".format(caller, caller.steam_id, args)))
